...
//                     <img style={{marginTop:'10px'}} width={200} src={file} />
//                     {/* <input type="file" onChange={uploadPhoto} /> */}
//                     {imagePreviewUrl && (
  ...
  const onFinish = async () => {
    try {
      ...
      if (selected === null) {
        ...
        let res = await request.pull("post", {
          ...values,
          photo: photoId,
          tags: tagsArray,
        });
            ...
            <div className="modal_wrapper">
              ...
              >
                ...
                >
                  ...
                  >
                    <h2>{selected ? "Change photo" : "Add photo"}</h2>
                    <input type="file" onChange={uploadPhoto} />
                    <img
                      style={{ marginTop: "10px" }}
                      width={200}
                      src={selected ? getImage(imagePreviewUrl) : imgSrc}
                    />
                  </Form.Item>
                  <Button danger type="primary" onClick={hideModal}>
                    Close
